...
export function Experience(props) {
  ...
  function fill() {
    if (answer) {
      ...
      console.log(answer.Until);
      document.querySelector(".ExperienceList>.Empresa").textContent =
        answer.Empresa;
      document.querySelector(".ExperienceList>.Puesto").textContent =
        answer.Puesto;
      document.querySelector(".ExperienceList>.From").textContent = answer.From;
      document.querySelector(".ExperienceList>.Until").textContent =
        answer.Until;
    }
  }
