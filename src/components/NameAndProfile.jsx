...
export function NameAndProfile(props) {
  ...
  function openModal() {
    ...
    ReactDOM.render(
      <InputModal id={"NameAndProfile"} sendBack={setAnswer} answer={answer} />,
  ...
  function fill() {
    if (answer) {
      ...
      document.querySelector("#NameAndProfile>#Name").textContent =
        answer.Nombre;
      document.querySelector("#NameAndProfile>#Profile").textContent =
        answer.Profile;
    }
  }
